...
class AppColors {
  ...
  static const Color brandSecondColor = Color.fromRGBO(243, 246, 255, 1);
  static const Color brandLigthColor = Colors.white;
  static const Color brandLigthColorBorder = Color.fromRGBO(210, 228, 255, 0.2);
  static const Color brandLigthColorOpacity = Color.fromRGBO(255, 255, 255, 1);
